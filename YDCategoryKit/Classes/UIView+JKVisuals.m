...
// 设置阴影效果
-(void)jk_setupShadowEffect{
    // Background Code
    self.backgroundColor = [UIColor whiteColor];
    CGFloat screenWidth = [UIScreen mainScreen].bounds.size.width;
    self.layer.cornerRadius = 8.0 * screenWidth/375.0;
    self.layer.masksToBounds = NO;
    self.layer.shadowColor   = [UIColor colorWithRed:231/255.0 green:231/255.0 blue:232/255.0 alpha:1.00].CGColor;
